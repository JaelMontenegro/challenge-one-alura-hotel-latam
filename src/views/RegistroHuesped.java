	...
	public RegistroHuesped(Reserva reserva) {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				huesped.setFechaNacimiento(new Timestamp(txtFechaN.getDate().getTime()));
				huesped.setIdReserva(reserva.getId());
				huesped.setNacionalidad(txtNacionalidad.getModel().getSelectedItem().toString());
				huesped.setNombre(txtNombre.getText());
				huesped.setTelefono(txtTelefono.getText());
				DB.guardarHuesped(huesped);
